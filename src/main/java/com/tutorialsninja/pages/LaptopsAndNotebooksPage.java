...
public class LaptopsAndNotebooksPage extends Utility {
    ...
    public void fillAllMandatoryField() {
        sendTextToElement(firstName, "kapil");
        sendTextToElement(lastName, "solanki");
        sendTextToElement(emailId, "Prime010@gmail.com");
        sendTextToElement(telephone, "07070223344");
        sendTextToElement(address, "105, High road");
        sendTextToElement(city, "London");
        sendTextToElement(postcode, "HA HAB");
